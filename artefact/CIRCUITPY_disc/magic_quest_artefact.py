...
class MagicQuestArtefact:
    """MagicQuestArtefact."""

    def __init__(self):
        super(MagicQuestArtefact, self).__init__()
        print(8 * "\n")
        print(42 * "*")
        print("MagicQuestArtefact")
    ...
    def handle_receive(self):
        ...
        if packet is not None:
            ...
            print(f"Received: {packet_text} (rssi:{self.rfm.last_rssi:0.1f}dBm)")
